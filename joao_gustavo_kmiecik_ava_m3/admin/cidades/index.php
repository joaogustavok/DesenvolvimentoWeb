                ...
                <?php foreach ($cidades as $cidade) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <a href="update_cidade.php?id=<?php echo $cidade['id']; ?>" class="btn btn-sm btn-warning">Editar</a>
                            <a href="delete_cidade.php?id=<?php echo $cidade['id']; ?>" class="btn btn-sm btn-danger">Excluir</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
